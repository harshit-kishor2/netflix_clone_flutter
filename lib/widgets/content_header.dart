...
import 'package:resposive_app_demo/models/models.dart';
import 'package:resposive_app_demo/widgets/widgets.dart';
                  ...
                  children: [
                    FlatButton.icon(
                      ...
                      icon: _videoController.value.isPlaying
                          ? const Icon(Icons.pause, size: 30.0)
                          : const Icon(Icons.play_arrow, size: 30.0),
